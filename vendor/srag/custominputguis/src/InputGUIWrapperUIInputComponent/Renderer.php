...
namespace srag\CustomInputGUIs\OpencastPageComponent\InputGUIWrapperUIInputComponent;
...
if (DICStatic::version()->is6()) {
     ...
     * Class Renderer
     *
     * @package srag\CustomInputGUIs\OpencastPageComponent\InputGUIWrapperUIInputComponent
     *
