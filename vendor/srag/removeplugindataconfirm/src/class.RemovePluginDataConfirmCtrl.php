...
use ilSession;
use ilUtil;
use srag\DIC\OpencastPageComponent\DICStatic;
use srag\DIC\OpencastPageComponent\DICTrait;

/**
 * Class RemovePluginDataConfirmCtrl
 *
 * @package           srag\RemovePluginDataConfirm\OpencastPageComponent
 *
 * @author            studer + raimann ag - Team Custom 1 <support-custom1@studer-raimann.ch>
 *
 * @ilCtrl_isCalledBy srag\RemovePluginDataConfirm\OpencastPageComponent\RemovePluginDataConfirmCtrl: ilUIPluginRouterGUI
 */
class RemovePluginDataConfirmCtrl
{
